...
import org.runelive.dump.OsrsNpcListDumper;
    ...
    public static MobDefinition get(int id) {
        ...
        switch (id) {
            ...
            case 1030:
                ...
                definition.description = "A grenwall impling. Right on, maaan.".getBytes();
                break;
            case 322:
                definition.copy(get(635));
            ...
            case 4252:
                ...
                definition.description = "Gunther, The RuneLive donation master.".getBytes();
                definition.combatLevel = 0;
                definition.actions = new String[5];
                definition.actions[0] = "Talk-to";
                definition.standAnimation = 808;
